...
class test_weather(unittest.TestCase):
    ...
    def test_analyze_dataset(self):
        self.assertEqual(cmd2("2016-1-1 to 2017-1-1"),[39.76656151419559,-11,84],"should be [39.76656151419559,-11,84]")
    def test_export_results(self):
        self.assertEqual(cmd3("csv"),True,"should export results in results.csv")
